...
[一张图看懂开源许可协议，开源许可证GPL、BSD、MIT、Mozilla、Apache和LGPL的区别](https://blog.csdn.net/cwt19902010/article/details/53736746)

![开源许可协议](./pic/开源许可证GPL、BSD、MIT、Mozilla、Apache和LGPL的区别.jpg)
...
我们很熟悉的**Linux**就是采用了**GPL**。GPL协议和BSD, Apache Licence等鼓励代码重用的许可很不一样。GPL的出发点是代码的开源/免费使用和引用/修改/衍生代码的开源/免费使用，但不允许修改后和衍生的代码做为闭源的商业软件发布和销售。这也就是为什么我们能用免费的各种linux，包括商业公司的linux和linux上各种各样的由个人，组织，以及商业软件公司开发的免费软件了。
...
[英文原文--请点击](http://www.mozilla.org/MPL/MPL-1.1.html)
